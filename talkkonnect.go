...
func (b *Talkkonnect) talkkonnectMenu(backgroundcolor string) {
	...
	log.Println("info: " + backgroundcolor + "│ <l> Clear Screen            │<m> Radio Channel (+)           │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│ <n> Radio Channel (-)       │<o> Ping Servers                │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│ <p> Panic Simulation        │<q> Repeat TX Loop Test         │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│ <r> Scan Channels On/Off    │<s> Thanks/Acknowledge          │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│ <t> Show Uptime             │<u> Display Version             │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│ <v> Online Radio On/Off     │<w> Dump XML Config             │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│ <x> Next Server             │<z> Next Server                 │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "├─────────────────────────────┴────────────────────────────────┤" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│ Voice Targets (whisper/shout), typed in the CLI:             │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│  vt list                     list configured + active target │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│  vt set <id> / vt clear      activate target <id> / target 0 │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│  vt next / vt prev           step through configured targets │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│  vt whisper <user>           whisper to one online user      │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│  vt add / vt help            add a target / full usage       │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "├──────────────────────────────────────────────────────────────┤" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│ Multicast (RTP to IP speakers), typed in the CLI:            │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│  mc status                   destination, filters, live mix  │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "│  mc on / mc off / mc toggle  start or stop multicast output  │" + backgroundreset)
	log.Println("info: " + backgroundcolor + "├──────────────────────────────────────────────────────────────┤" + backgroundreset)
